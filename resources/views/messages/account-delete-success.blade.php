<div id="account-delete-success-{{$account->id}}" class="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center">
    <div class="bg-white shadow-lg rounded-lg max-w-md w-full p-4">
            ...
            <div class="flex justify-end mb-2">
                ...
                onclick="document.getElementById('account-delete-success-{{$account->id}}').classList.add('hidden')" >OK</button>
            </div>
